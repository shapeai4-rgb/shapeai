      ...
      <form onSubmit={submit} className="grid gap-4 text-sm" noValidate>
        ...
        {mode === 'signup' && (
          <div className="flex items-center gap-2">
            ...
            <label htmlFor="terms" className="text-xs text-neutral-slate"> I agree to the <a href="#" className="underline hover:text-neutral-ink">Terms</a> and <a href="#" className="underline hover:text-neutral-ink">Privacy Policy</a></label>
          </div>
        )}
