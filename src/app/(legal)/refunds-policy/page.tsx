    ...
    <div className="mx-auto max-w-4xl px-4 py-8">
      <div className="prose prose-lg max-w-none">
        ...
        <p className="text-neutral-slate mb-8">
          ...
          Support email: info@shapeai.co.uk | Phone: +44 7463 585216<br />
        ...
        <div className="bg-neutral-lines/10 p-6 rounded-lg text-neutral-slate">
          <p className="mb-2"><strong>Support email:</strong> info@shapeai.co.uk | <strong>Phone:</strong> +44 7463 585216</p>
